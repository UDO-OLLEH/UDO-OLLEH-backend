...
public enum ErrorCode {
    ...
    SHIP_FARE_DUPLICATED(HttpStatus.FORBIDDEN, "SHIP_FARE_001", "SHIP_FARE_DUPLICATED"),
    NOT_FOUND_SHIP_FARE(HttpStatus.NOT_FOUND, "SHIP_FARE_002", "NOT_FOUND_SHIP_FARE"),
