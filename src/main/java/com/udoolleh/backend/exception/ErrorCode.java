...
public enum ErrorCode {
    ...
    WHARF_NAME_DUPLICATED(HttpStatus.FORBIDDEN, "WHARF_001", "WHARF_NAME_DUPLICATED"),
    NOT_FOUND_WHARF(HttpStatus.NOT_FOUND, "WHARF_002", "NOT_FOUND_WHARF"),
    WHARF_TIME_DUPLICATED(HttpStatus.FORBIDDEN, "WHARF_003", "WHARF_TIME_DUPLICATED"),
    NOT_FOUND_WHARF_TIMETABLE(HttpStatus.NOT_FOUND, "WHARF_004", "NOT_FOUND_WHARF_TIMETABLE"),
